...
* [x] 项目初始化与技术选型 (100% - 已完成)
* [x] 基础UI框架完成
    * 基础界面框架 (80% - 进行中)
    * 主题切换 (100% - 完成)
* [ ] 核心功能实现
    * 待办事项管理 (70% - 进行中)
        * 列表视图 (ListView) (85% - 基本完成)
            * 列表数据展示与分页 (100% - 完成)
            * 任务添加功能 (100% - 完成)
            * 任务状态切换 (100% - 完成)
            * 任务编辑与删除 (90% - 基本完成)
        ...
        * 任务卡片组件 (80% - 基本完成)
            ...
            * 标签系统 (60% - 开发中)
    * 日程安排 (60% - 进行中)
        * 时间线视图 (TimelineView) (75% - 基本完成)
            * 今天/明天/下周分组 (100% - 完成)
            * 事件展示与交互 (80% - 基本完成)
            * 拖拽调整功能 (30% - 开发中)
        * 日历视图 (CalendarView) (65% - 开发中)
            * 月/周/日视图切换 (90% - 基本完成)
            * 事件创建与删除 (70% - 开发中)
            * 事件拖拽调整 (50% - 开发中)
            * 与后端数据同步 (40% - 开发中)
    * 知识库管理 (50% - 进行中)
        * Markdown编辑器集成 (70% - 基本完成)
        * 内容存储与检索 (60% - 开发中)
        * 图片与附件支持 (30% - 初步开发)
* [ ] 数据管理与存储
    * 事件存储 (EventStore) (80% - 基本完成)
        * 基础CRUD操作 (100% - 完成)
        * 分页加载 (80% - 基本完成)
        * 缓存管理 (70% - 开发中)
    * 列表存储 (ListStore) (85% - 基本完成)
        * 列表管理功能 (100% - 完成)
        * 排序与筛选 (70% - 开发中)
    * 时间线存储 (TimelineStore) (75% - 开发中)
        * 时间分组管理 (90% - 基本完成)
        * 事件过滤与排序 (70% - 开发中)
* [ ] AI助手功能集成
    * AI agent开发 (50% - 开发中)
...
| 角色 | 负责人 | 工作内容 |
|------|-------|---------|
| 项目负责人 |嵇煜人 |负责进行团队沟通，协调项目进度 |
| 前端开发 |孙一鸣 |实现设计好的ui界面并提出改进 |
| 后端开发 |嵇煜人 |完成数据持久化 |
| UI/UX设计 |嵇煜人和孙一鸣 |确定界面的展示形式 |
| AI功能开发 |嵇煜人 |接入了LLM的api，设计了ai工作流 |
| 测试 |孙一鸣 |测试程序bug并提醒修改 |
