                ...
                <template v-if="lists.length > 0">
                    <v-list>
                        <div
                            ...
                            :key="list.id"
                            class="list-item-wrapper mb-2"
                        >
                            <v-list-item
                                :value="list"
                                rounded="lg"
                                @click="handleClick(`list-item/${list.id}`)"
                                v-ripple
                                v-touch="{
                            ...
                            <div class="edit-buttons" :class="{ 'show': editingIndex === index }">
                                <v-btn
                                    ...
                                    variant="text"
                                    density="comfortable"
                                    @click.stop="showRenameDialog(list)"
                                ></v-btn>
                                <v-btn
                                    icon="mdi-delete"
                                    color="error"
            ...
            <v-card>
                ...
                <v-card-actions>
                    ...
                    <v-btn
                        color="primary"
                        variant="text"
                        @click="handleRename(editDialog.list?.id, editDialog.newName)"
